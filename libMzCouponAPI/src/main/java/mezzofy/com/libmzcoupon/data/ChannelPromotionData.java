...
public class ChannelPromotionData {
    ...
    public String getPlayCampId() {
        return playCampId;
    }

    public void setPlayCampId(String playCampId) {
        this.playCampId = playCampId;
    }

    public String getChannelPlayId() {
        return channelPlayId;
    }

    public void setChannelPlayId(String channelPlayId) {
