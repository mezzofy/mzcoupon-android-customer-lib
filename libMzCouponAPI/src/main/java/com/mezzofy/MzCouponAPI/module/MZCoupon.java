...
public class MZCoupon {
    ...
    public CustomerCouponListDataModel getCouponsByStatus(String customerId) {

        Gson gson = new Gson();
        String campaign = jsonstrings.getJSONFromUrl(CommonModule.getUserpath(context) + "api/v1/customercoupons/customercampaigns?customerid="+customerId+"&status=A");
